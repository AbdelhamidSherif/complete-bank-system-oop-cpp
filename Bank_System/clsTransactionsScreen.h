...
private:
	...
	static void _PerformTransactionsMenueOptions(_enTransactionsMenueOptions TransactionisMenueOption)
	{
		switch (TransactionisMenueOption)
		{
...
public:
	static void ShowTransactionsMenue()
	{
		...
		_PerformTransactionsMenueOptions((_enTransactionsMenueOptions)_ReadTransactionsMenueOptions());
	}
